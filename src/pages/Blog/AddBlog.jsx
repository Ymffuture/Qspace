...
const AddBlog = () => {
    ...
    return (
        <div>
            <Card className="pt-5">
                <CardContent>
                    <h1 className='text-2xl font-bold mb-4 flex gap-3'> <IoAdd/>post</h1>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)}  >
                            ...
                            <div className='mb-3'>
                                ...
                                <Dropzone onDrop={acceptedFiles => handleFileSelection(acceptedFiles)}>
                                    {({ getRootProps, getInputProps }) => (
                                        <div {...getRootProps()}>
                                            <input {...getInputProps()} />
                                            <div className='flex justify-center items-center w-36 h-28 border-2 border-dashed rounded-0'>
                                                <img src={filePreview} />
                                            </div>
                                        </div>
                                    )}
                            ...
                            <Button type="submit" className="w-full bg-black">Submit</Button>
                        </form>
                    </Form>
