...
const SignIn = () => {
    ...
    return (
        <div className='flex justify-center items-center h-screen w-screen bg-[#23272E]'>
            <Card className="w-[400px] p-5 bg-[#23272E] text-white">
                <div className='flex justify-center items-center mb-2'>

                    <Link to={RouteIndex} className='w-[120px]'>
                        <img src={logo} />
                    </Link>
                </div>
                ...
                <div className=''>
                    ...
                    <div className='border my-5 flex justify-center items-center'>
                        <span className='absolute bg-[#23272E] text-sm'>Or</span>
                    </div>
